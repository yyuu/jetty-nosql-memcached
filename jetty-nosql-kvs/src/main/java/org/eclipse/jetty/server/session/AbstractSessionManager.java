...
public abstract class AbstractSessionManager extends ContainerLifeCycle implements SessionManager
{
    ...
    protected AbstractSessionIdManager _sessionIdManager;
    ...
    public void doStart() throws Exception
    {
        ...
        synchronized (server)
        {
            ...
            {
                _sessionIdManager = (AbstractSessionIdManager) server.getSessionIdManager();
                if (_sessionIdManager==null)
                {
    ...
    public AbstractSessionIdManager getSessionIdManager()
    {
    ...
    public void setSessionIdManager(SessionIdManager metaManager)
    {
        ...
        if (metaManager instanceof AbstractSessionIdManager) {
            _sessionIdManager = (AbstractSessionIdManager) metaManager;
        }
    }
    ...
    protected void addSession(AbstractSession session, boolean created)
    {
        ...
        {
            // Since KeyValueStoreSessionIdManager do nothing, comment out addSession.
//            _sessionIdManager.addSession(session);
    ...
    public boolean removeSession(AbstractSession session, boolean invalidate)
    {
        ...
        if (removed)
        {
            ...
            // Since KeyValueStoreSessionIdManager do nothing, comment out removeSession.
