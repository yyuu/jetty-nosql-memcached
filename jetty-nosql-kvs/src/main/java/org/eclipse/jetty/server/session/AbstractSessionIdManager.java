...
public abstract class AbstractSessionIdManager extends ContainerLifeCycle implements SessionIdManager
{
    ...
    /* ------------------------------------------------------------ */
    @Override
    public abstract String renewSessionId(String oldClusterId, String oldNodeId, HttpServletRequest request);
